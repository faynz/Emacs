...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(fringe ((t (:foreground ,molokai-bg :background ,molokai-bg))))
   ...
   `(header-line ((,class (:background ,molokai-bg)) (t :weight bold)))

   ;; vertical-border
   `(vertical-border ((t (:foreground ,molokai-bg :background ,molokai-bg))))

   ;; powerline
   `(powerline-active0 ((,class (:background ,molokai-bg :foreground ,molokai-orange))))
   `(powerline-active1 ((,class (:background ,"#83BF9D" :foreground ,molokai-bg))))
   `(powerline-active2 ((,class (:background ,molokai-bg :foreground ,molokai-palevioletred))))
   `(powerline-active3 ((,class (:background ,molokai-bg :foreground ,molokai-yellow))))
   `(powerline-active4 ((,class (:background ,molokai-orange :foreground ,molokai-bg))))
   `(powerline-active5 ((,class (:background ,molokai-bg :foreground ,molokai-fg))))
   `(powerline-inactive0 ((,class (:background ,molokai-bg :foreground ,molokai-base01))))
   `(powerline-inactive1 ((,class (:background ,molokai-bg :foreground ,molokai-base01))))
   `(powerline-inactive2 ((,class (:background ,molokai-bg :foreground ,molokai-base01))))
   `(powerline-inactive3 ((,class (:background ,molokai-bg :foreground ,molokai-base01))))
   `(powerline-inactive4 ((,class (:background ,molokai-bg :foreground ,molokai-base01))))
   `(powerline-inactive5 ((,class (:background ,molokai-bg :foreground ,molokai-base01))))

   ;;;;; ivy
   `(ivy-virtual ((,class (:foreground ,molokai-grey+2))))
   ...
   `(neo-header-face ((t (:foreground ,molokai-bg))))
