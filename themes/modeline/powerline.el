...
(defface powerline-active1 '((t (:inherit mode-line)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-active2 '((t (:inherit mode-line)))
  "Powerline face 2."
  :group 'powerline)

(defface powerline-active3 '((t (:inherit mode-line)))
  "Powerline face 3."
  :group 'powerline)

(defface powerline-active4 '((t (:inherit mode-line)))
  "Powerline face 4."
  :group 'powerline)

(defface powerline-active5 '((t (:inherit mode-line)))
  "Powerline face 5."
  :group 'powerline)
...
(defface powerline-inactive3 '((t (:inherit mode-line-inactive)))
  "Powerline face 3."
  :group 'powerline)
...
(defface mode-line-buffer-id-inactive
  '((t (:inherit mode-line-buffer-id-inactive)))
